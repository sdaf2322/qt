...
signals:
    void clear_productTableView();                                                                         // productTreeWidget의 내용을 지우기 위한 시그널
...
private:
    ...
    QHash<int, QString> client_name;
    QHash<int, QString> product_price;
    QHash<int, QString> product_name;
