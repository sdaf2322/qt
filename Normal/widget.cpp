...
void Widget::getNormal(GLfloat a[3], GLfloat b[3], GLfloat c[3],GLfloat normal[3])
{
    ...
    //정규화
    GLfloat l = sqrt(n[0]*n[0]+ n[1] + n[2]*n[2]);
    normal[0]=n[0]/l;normal[1]=n[1];normal[2]=n[2]/l;
}
...
void Widget::keyPressEvent(QKeyEvent* event)
{
    ...
    case Qt::Key_W:         // Ambient OFF
        bNormal = GL_FALSE;
        break;
    case Qt::Key_1:         // Attach light
        yAngle += 2;
        break;
    case Qt::Key_2:         // Unattach light
        yAngle -= 2;
        break;
    case Qt::Key_3:
        xAngle += 2;
    ...
    QString str;
    str.sprintf("x: %.1f,y:%.1f,z:%.1", xAngle, yAngle, zAngle);
    setWindowTitle(str);
    update();
}
